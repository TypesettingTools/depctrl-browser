...
(function(){
  ...
  var i = 0;
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.AlignAndDistribute/",
        name: "Align and Distribute",
        description: "Align and distribute lines relative to something.",
      }
    );
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.terrain/",
        name: "terrain",
        description: "Interpolate between two vectorial clips with same number of points.",
      }
    );
